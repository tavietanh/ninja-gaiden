...
VirtualObject::VirtualObject(D3DXVECTOR3 _position, eDirection _direction, eObjectID _objectID) : CObjectDx9(_position, _direction, _objectID)

{

}

VirtualObject::VirtualObject(D3DXVECTOR3 _position, int _width, int _height, eObjectID _ObjectID) : CObjectDx9(_position, eDirection::NONE, _ObjectID)
{
...
void VirtualObject::UpdateCollision(CObjectDx9* checkingObject)
{
